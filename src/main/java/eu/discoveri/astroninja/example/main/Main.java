...
import eu.discoveri.astroninja.visualise.GEXFutils;
...
public class Main
{
    ...
    {
        // Output JSON file
        String GEXFILE = "/home/chrispowell/NetBeansProjects/AstroNinja/src/main/java/eu/discoveri/astroninja/html/network.json";
        // 'Start' node
        PersonImpl p1 = null;
...
//                   db.persist( f4 );
        ...
        // Output graph
        GEXFutils.writeGEXF(gr,p1,graphName,GEXFILE);
